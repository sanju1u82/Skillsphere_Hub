...
<?php
          if(isset($_GET['course_id'])){ //checking course_id
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <form action="checkout.php" method="post">
                      ...
                      <button type="submit" class="btn btn-primary text-white font-weight-bolder" name="buy" style="background-color: #1c0909; float: right; bottom:0; border-color: #1c0909;">Buy Now</button>
                    </form>
                  </div>
                </div>
              ';
