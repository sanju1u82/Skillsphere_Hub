...
?>
 <div class="col-sm-6 mt-5" style="color: black;">
  <form class="mx-5" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn btn-primary" name="updateStuNameBtn" style="background-color:  #1c0909; border-color:  #1c0909; color: white;">Update</button>
