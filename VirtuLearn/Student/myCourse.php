                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="card-body">
                                        ...
                                        <a href="watchcourse.php?course_id=<?php echo $row['course_id'] ?>" class="btn btn-primary mt-5 float-right" style="background-color:  #1c0909; border-color: #1c0909">Watch Course</a>
                                    </div>
                                </div>
                            </div>
                        </div>
