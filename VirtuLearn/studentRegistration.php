...
<form role="form" id="stuRegForm">
        ...
        <small id="statusMsg2"></small><input type="email"
        ...
        <div class="form-group">
            ...
            Password</label>
            <small id="statusMsg3"></small><input type="password" class="form-control" placeholder="Password" name="stupass" id="stupass">
        </div>
        </form>
